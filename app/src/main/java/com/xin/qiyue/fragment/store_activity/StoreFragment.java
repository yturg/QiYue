package com.xin.qiyue.fragment.store_activity;
...
import com.xin.qiyue.apple.util.MyViewPagerAdapter;
...
public class StoreFragment extends Fragment implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    public void onClick(View view) {
        Intent intent = new Intent(getActivity(),ProductScanActivity.class);
        switch (view.getId()){
