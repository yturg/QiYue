...
import com.xin.qiyue.apple.xhs.ServiceHelpActivity;
import com.xin.qiyue.widget.InfoSettingTitle;
import com.xin.qiyue.widget.SelfNoteCard;
                ...
                for(int i = list.size()-1 ; i >= 0 ; i--){
                    ...
                    card.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            //跳转到该笔记浏览页面
                            Intent intent = new Intent(SelfNoteScan.this,NoteScanActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.my_setting_done:
                startActivity(new Intent(SelfNoteScan.this, ServiceHelpActivity.class));
                break;
        }
    }
}
