...
public class LoginOrLogonActivity extends BaseActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.welcome_to_login) {
            startActivity(new Intent(LoginOrLogonActivity.this, LoginActivity.class));
        } else if (id == R.id.welcome_to_logon) {
            startActivity(new Intent(LoginOrLogonActivity.this, LogonActivity.class));
        }
    }
